...
are defined as:
\begin{equation}
    [\text{Lower Bound}, \text{Upper Bound}] = [Q_1 - 1.5 \times \text{\gls{iqr}}, Q_3 +
    1.5 \times \text{\gls{iqr}}]
\end{equation}
...
A custom YOLO26s model~\cite{jocher_ultralytics_2023} was fine-tuned on the \gls{sam}-generated
