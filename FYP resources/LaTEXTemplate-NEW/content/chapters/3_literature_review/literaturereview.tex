...
generalization~\cite{dosovitskiy2020image}. This thesis utilizes models such as SAM~2 and
...
``plain ViT'' backbone and simple decoder head, an architectural choice that prioritizes feature
